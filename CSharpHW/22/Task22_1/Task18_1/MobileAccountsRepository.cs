...
namespace Task18_1
{
    internal class MobileAccountsRepository
    {
        ...
        public void XmlSerialize()
        {
            ...
            _mySerializer.Compress("SerializedRepository.xml", "SerializedRepositoryXml.zip");
            var info = new FileInfo("SerializedRepository.xml");
            info.Delete();
        }

        public void XmlDeserialize()
        {
            _mySerializer.DeCompress("SerializedRepositoryXml.zip", "SerializedRepository.xml");
